...
import aaa.bbb.novemberaver.databinding.ActivitySignalTwoBinding
...
class SignalTwoActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySignalTwoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySignalTwoBinding.inflate(layoutInflater)
        ...
        binding.bNav2.selectedItemId = R.id.signals
        binding.bNav2.setOnNavigationItemSelectedListener {
            when (it.itemId){
                R.id.trading -> {
